export const inputText: string = `# Solução da equação de 2º grau:  x^2-10*x+24=0
...
export const inputLines: string[] = inputText.split('\n');
...
var inputLines: Array<string> = inputText.split("\n");//*/
